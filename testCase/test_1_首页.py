...
class tc_首页(st_首页):
    ...
    def test_002_点击切换站点toast切换站点_武昌站(self):
        ...
        a3 = dr.get_首页顶部_当前站点()
        a = a1 + str(a2) + a3
        self.myEq(a, '定位显示您在“武昌站”附近1武昌站', "点击切换站点toast切换站点_武昌站")
    ...
    def test_010_banner车站流量跳转(self):
    ...
    def test_030_车次号为空toast提示(self):
        ...
        self.myEq(a, "请输入正确的车次号", "请输入正确的车次号_toast")
    ...
    def test_033_车次查询标签页切换(self):
        ...
        dr.click_首页_车次查询()
        a = dr.get_车次号输入框示例()
        self.myEq(a, "车次号 例如：G9", "车次查询标签页切换")
