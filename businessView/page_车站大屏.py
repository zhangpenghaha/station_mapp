...
class page_车站大屏(page_首页):
    ...
    text_车次号=loc_child_TtoC_Number("wx8d75e764f0c4bf1c:pages/station/pages/stationLargeScreen/index.html:VISIBLE","android.view.View",12)
    ...
    "结果页"
    text_浠水站=loc_child_TtoC_Number("wx8d75e764f0c4bf1c:pages/station/pages/selectSite/index.html:VISIBLE","android.view.View",6)
