...
class page_意见反馈(page_个人中心):
    ...
    def send_意见反馈_详细描述(self,详细描述内容):
        self.clear_清除(self.ipb_意见反馈_详细描述,"ipb_详细描述")
        self.send_输入(self.ipb_意见反馈_详细描述,"ipb_详细描述",详细描述内容)

    def send_意见反馈_联系方式(self,联系方式内容):
        self.click_点击(self.btn_意见反馈_联系方式,"btn_联系方式")
        sleep(1)
        self.clear_清除(self.ipb_意见反馈_联系方式,"ipb_联系方式")
        self.send_输入(self.ipb_意见反馈_联系方式,"ipb_联系方式",联系方式内容)
